...
@WithMockUser(username = "wasya", password = "root", authorities = "ROLE_MODERATOR")
class UserControllerTest extends BaseIntegrationTest {
    ...
    void initNecessaryMocks() {
        testUserRequest = new UserRequest("wasya", "wasya@mail.ru", "root", "den", "zag");
        testInvalidUserRequest = new UserRequest("", "wasya@mail.ru", "root", "den", "zag");
